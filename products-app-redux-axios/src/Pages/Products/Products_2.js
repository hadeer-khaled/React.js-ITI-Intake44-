...
import { getproductsListThunk } from "../../store/slices/productsSlice.js";
...
const Products = () => {
  ...
  console.log(productsList); // undefined
  ...
  useEffect(() => {
    ...
    getProducts()
      .then((res) => {
        ...
        // products_api will be undefined cuz setProducts_api(res. .products) is asynchronous
